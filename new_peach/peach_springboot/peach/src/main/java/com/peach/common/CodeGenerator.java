...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        String projectPath = System.getProperty("user.dir")+"/peach";
        ...
        // ⼀、修改数据源
        dsc.setUrl("jdbc:mysql://localhost:3306/peach_sql?useUnicode=true&characterEncoding=utf-8&useSSL=false");
                // dsc.setSchemaName("public");
                dsc.setDriverName("com.mysql.cj.jdbc.Driver");
        dsc.setUsername("root");
        dsc.setPassword("mao0524@wang");
        mpg.setDataSource(dsc);
        // 包配置
        PackageConfig pc = new PackageConfig();
        //pc.setModuleName(scanner("模块名"));
        // ⼆、模块配置
        pc.setParent("com.peach")
                .setEntity("entity")
                .setMapper("mapper")
                .setService("service")
